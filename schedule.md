...
| **15** | Wed 10/28 | **[Eulerian Reconstruction]({{ '/sessions/15/' | relative_url }})** | Midterm: draft |
| **16** | Fri 10/30 | **[Errors, Repeats, Coverage, and k-mer Spectra]({{ '/sessions/16/' | relative_url }})** | Midterm: peer review |
| **17** | Wed 11/4 | **[Sequence Comparison as Optimization]({{ '/sessions/17/' | relative_url }})** |  |
| **18** | Fri 11/6 | **[Dynamic Programming and Global Alignment]({{ '/sessions/18/' | relative_url }})** | Pull request/code review 2 |
...
| **22** | Fri 11/20 | **[Final Project: Architecture and Interface Design]({{ '/sessions/22/' | relative_url }})** |  |
|  | Wed 11/25 & Fri 11/27 | **Thanksgiving recess — no class** |  |
| **23** | Wed 12/2 | **[Final Project I: Data Representations]({{ '/sessions/23/' | relative_url }})** | Final Project: Proposed implementation |
...
|  | Sun 12/20, 11:59 p.m. | **Final project deadline** | Final Project: Iteration |
